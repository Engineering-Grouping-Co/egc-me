  ...
  return (
    <>
            ...
            <div className={`feature-grid${idx % 2 !== 0 ? ' div-reverse' : ''}`}>
              ...
              <FadeIn>
                <div className="div-header">
                  <p className="overline">Division {div.num}</p>
                  {div.badge && <span className="div-new-badge">{div.badge}</span>}
                </div>
                <h2 className="headline-lg" style={{ marginBottom: 6 }}>{div.label}</h2>
                <p className="div-tag-line">{div.tag}</p>
      ...
      <style>{`
        ...
        .div-tag-line { font-size: 0.72rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: var(--blue); margin-bottom: 0; }
        ...
        .cap-item { background: var(--gray-bg); border: 1px solid var(--border); border-radius: var(--radius); padding: 14px 16px; }
        ...
        .spec-k { font-size: 0.82rem; font-weight: 600; color: var(--dark); padding: 10px 0; width: 40%; vertical-align: top; }
        .spec-v { font-size: 0.82rem; color: var(--muted); padding: 10px 0 10px 16px; vertical-align: top; }
